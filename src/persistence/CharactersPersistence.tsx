...
export async function fetch_series_characters(
  seriesId: string
): Promise<Character[]> {
...
export async function add_new_character(
  char_props: AddCharacterProps
): Promise<Boolean> {
  try {
    ...
    const { data, error } = await supabase.rpc(
      "req_add_character_with_family",
      {
        ...
        character_media_file:
          "https://mkcijqngeshomivhjrbe.supabase.co/storage/v1/object/public/image-bucket/defaults/avatar-2.jpg",
